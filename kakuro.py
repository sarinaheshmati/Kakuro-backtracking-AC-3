...
#choose an input (a game board)
    ...
    # #input 3 (8*8):
    # horizontal = [['#', '#', '#', '#', '#', '#', '#', '#'], ['#', '19', '0', '0', '0', '10', '0', '0'],
    #             ['39', '0', '0', '0', '0', '0', '0', '0'], ['15', '0', '0', '10', '0', '0', '#', '#'],
    #             ['#', '16', '0', '0', '4', '0', '0', '#'], ['#', '#', '9', '0', '0', '12', '0', '0'], 
    #             ['35', '0', '0', '0', '0', '0', '0', '0'], ['16', '0', '0', '7', '0', '0', '0', '#']]
    # vertical = [['#', '#', '#', '#', '#', '#', '#', '#'], ['#', '16', '0', '0', '#', '14', '0', '0'],
    #             ['30', '0', '0', '0', '0', '16', '0', '0'], ['4', '0', '0', '23', '0', '0', '0', '#'],
    #             ['24', '0', '0', '0', '6', '0', '0', '0'], ['#', '9', '0', '0', '0', '4', '0', '0'], 
    #             ['4', '0', '0', '10', '0', '0', '0', '0'], ['16', '0', '0', '#', '16', '0', '0', '#']]
    # number_of_rows = 8
    # number_of_columns = 8
    ...
    # vertical = [['#', '#', '#', '#', '#', '#', '#', '#', '#', '#'], ['10', '0', '0', '#', '#', '#', '#', '4', '0', '0'],
    #             ['10', '0', '0', '0', '#', '#', '7', '0', '0', '0'], ['#', '17', '0', '0', '#', '6', '0', '0', '0', '#'],
    #             ['#', '#', '20', '0', '0', '0', '0', '0', '#', '#'], ['#', '#', '#', '20', '0', '0', '0', '#', '#', '#'], 
    #             ['#', '#', '30', '0', '0', '0', '0', '0', '#', '#'], ['#', '17', '0', '0', '0', '#', '3', '0', '0', '#'], 
    #             ['23', '0', '0', '0', '#', '#', '9', '0', '0', '0'], ['16', '0', '0', '#', '#', '#', '#', '4', '0', '0']]
    # number_of_rows = 10
